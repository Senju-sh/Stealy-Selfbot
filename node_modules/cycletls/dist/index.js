...
const handleSpawn = (debug, fileName, port, filePath) => {
    try {
        ...
        child = (0, child_process_1.spawn)(execPath, [], spawnOptions);
        child.stderr.on("data", (stderr) => {
            ...
            if (errorMessage.includes("Request_Id_On_The_Left")) {
                ...
                if (debug) {
                    ...
                    cleanExit(`Error Processing Request (please open an issue https://github.com/Danny-Dasilva/CycleTLS/issues/new/choose) -> ${errorMessage}`, false).then(() => handleSpawn(debug, fileName, port));
                }
            }
        });
